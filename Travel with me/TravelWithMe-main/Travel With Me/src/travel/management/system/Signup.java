...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
        ...
        c1 = new Choice();
        c1.add("Your fav FRIENDS charactor ?");
        c1.add("Your fav movie?");
        c1.add("Your Birth Date?");
        ...
        JLabel l7 = new JLabel("Let's set up your account ");
        l7.setBounds(510, 290, 220, 25);
        l7.setFont(new Font("MV Boli", Font.BOLD, 20));
        add(l7);

        JLabel l8 = new JLabel("Spare a minute with us");
