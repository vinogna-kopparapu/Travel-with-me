...
public class Dashboard extends JFrame implements ActionListener, MouseListener, Runnable {
   ...
   Dashboard(String username) {
        ...
        p1.setBackground(new ColorUIResource(255, 219, 223));
        ...
        JLabel l3 = new JLabel("Explore & Live a New Adventure");
        ...
        JLabel copyright = new JLabel("TWM");
        copyright.setBounds(10, 680, 160, 25);
        p2.add(copyright);

        // Add Dashboard Buttons

        b1 = new JButton("   Add User Details");
        ...
        b2 = new JButton("   Update User Details");
        ...
        b3 = new JButton("   View User Details");
        ...
        b4 = new JButton("   Delete User Details");
        ...
        b5 = new JButton("   Check available Package");
        ...
        b6 = new JButton("   Book your Package");
        ...
        b9 = new JButton("   Book your Hotel");
        ...
        b17 = new JButton("   Book Transportation");
        b17.setBackground(new Color(0, 0, 102));
        b17.setHorizontalAlignment(SwingConstants.LEFT);
        b17.setBackground(Color.WHITE);
        b17.setFont(new Font("Tahoma", Font.BOLD, 17));
        b17.setForeground(Color.blue);
        b17.setBounds(0, 440, 250, 40);
        b17.setBorder(BorderFactory.createLineBorder(Color.blue));
        b17.setMargin(new Insets(0, 0, 0, 102));
